...
public class CommonConfiguration implements ICommonConfig
{
    ...
    public JsonObject serialize()
    {
        ...
        entry4.addProperty("desc:", "Skips adding items already present in the loot, to avoid stacking additional items. Note that this increases the chance for modded loot aswell. default:false");
